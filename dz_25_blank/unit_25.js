...
function t1() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=1', true);
    xhr.send();
...
function t2() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=stas', true);
    xhr.send();
...
function t3() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=6&num2=12', true);
    xhr.send();
...
function t4() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=6&num2=12', true);
    xhr.send();
...
function t5() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=5', true);
    xhr.send();
...
function t6() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=6&num2=12', true);
    xhr.send();
...
function t7() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=7', true);
    xhr.send();
...
function t8() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1991', true);
    xhr.send();
...
function t9() {
    ...
    xhr.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=9&m=1&d=1&y=1', true);
    xhr.send();
