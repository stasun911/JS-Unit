...
document.querySelector('.three').innerHTML = '<h3>раз два три</h3>';
...
document.querySelector('.four').innerHTML = '<h4>четыре пять</h4>';
document.querySelector('.four').innerHTML += '<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita laboriosam soluta aspernatur repudiandae natus, cum iste magni ab minus veniam veritatis quae doloremque labore, consequatur eius esse inventore maiores odio.</p>'
// Task 12.
