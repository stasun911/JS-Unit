...
function f1() {
    document.querySelector('.b-1').onclick = alert('task 1')
...
function f2() {
    document.querySelector('.b-2').onclick = alert('task 2')
...
function f3() {
    document.querySelector('.p-3').onclick = alert('task 3')
...
function f8() {
    out8.innerHTML += '<div class="form-control">Input i-81 <input type="text" class="i-81"></div>';
    out8.innerHTML += '<button class="button-primary b-81">Task-8</button>';
    out8.innerHTML += '<div class="out-81"></div>';
