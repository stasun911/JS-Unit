...
function f5() {
    document.querySelector('.out-5').textContent = out4.classList.contains('bg-4')
}
...
function f6() {
    document.querySelector('.out-6').textContent = document.getElementsByClassName('p-6').length;
}
...
function f11() {
    ...
    // append добавляет указанный в параметре элемент внутрь элемента, который указан перед точкой
}
...
function f12() {
    ...
    document.querySelector('.out-12').append(a);
}
...
function f14() {
    ...
    // prepend добавляeт указанный в параметре элемент внутрь элемента, который указан перед точкой
...
function f15() {
    ...
    // before  добавляет элемент до элемента, который указан перед точкой
}
...
function f16() {
    ...
    // after добавлет элемент после элемента, который указан перед точкой
}
...
function f18() {
    ...
    document.querySelector('.out-18').textContent = datab;
}
