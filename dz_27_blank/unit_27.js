...
function t2() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=6&num2=15')
        .then(data => {
            resolve(data.text())
        })
    });
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=6&num2=15')
        .then(data => {
            resolve(data.text())
        })
    });
...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=6&num2=15')
        .then(data => {
            resolve(data.text())
        })
    });
...
function t5() {
    ...
    let b = new Promise((resolve, reject) => {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=2&name=stas'
    })
        .then(data => {
            resolve(data.text())
        })
...
function t6() {
    let a = new Promise((resolve, reject) => {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=3&num1=6&num2=15'
    })
        .then(data => {
            resolve(data.text())
        })
    ...
    let b = new Promise((resolve, reject) => {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=4&num1=6&num2=15'
    })
        .then(data => {
            resolve(data.text())
        })
...
function t7() {
    ...
    let b = new Promise((resolve, reject) => {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=6&num1=6&num2=15'
    })
        .then(data => {
            resolve(data.text())
        })
