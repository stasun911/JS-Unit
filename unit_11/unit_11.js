...
function f5() {
    i5 = document.querySelector('.i-5').value;
    d1.unshift(i5);
    showArr('.out-5', d1);
}
...
function f13() {
    ...
    // =============
    // i = 0
    // t [0] = d[ 3 -1 - 0]  /// d [2] = 9 -> t[0] = 9
    // i = 1
    // t [1] = d [ 3 -1 -1 ] // d[1] = 8 -> t[1] = 8 
    // i = 2
    // t [2] = d [3 -1 -2 ] // t[2] = d[0]  -> t[2] = 7
    // ====================
    // t [ 9,8,7]
...
function f14() {
    i14 = +document.querySelector('.i-14').value;
...
function f15() {
    ...
    if (d15.indexOf(i15) == 0);

    else if (d15.indexOf(i15) == -1) {
        d15.push(i15);
    }
...
function f18() {
    ...
    document.querySelector('.out-18').textContent = d18.includes(document.querySelector('.i-18').value);
}
